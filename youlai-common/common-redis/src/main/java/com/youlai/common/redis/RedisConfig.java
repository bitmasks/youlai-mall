...
import com.youlai.common.redis.distributeLock.lua.lock.LuaDistributedLock;
import com.youlai.common.redis.distributeLock.lua.manager.IIuaLockManager;
import com.youlai.common.redis.distributeLock.lua.manager.LuaRedisLockManager;
...
public class RedisConfig {
    ...
    ILuaBaseLock luaDistributedLock(LockProperties lockProperties){
        LuaDistributedLock luaDistributedLock = new LuaDistributedLock();
    ...
    @Bean
    IIuaLockManager luaRedisLockManager(ILuaBaseLock luaBaseLock){
        LuaRedisLockManager luaRedisLockManager = new LuaRedisLockManager();
        luaRedisLockManager.setDistributeLock(luaBaseLock);
        return luaRedisLockManager;
    }
